...
@router.get("/get_complete_conversation_from_session/{session_id}")
async def get_complete_conversation_from_session(
    ...
    try:
        ...
        return await chat_service.get_complete_conversation_from_session(session_id)
...
async def chat_with_bot(
    ...
    session, session_uuid = await chat_service.resolve_session(
        request, response, session_uuid_input
    )
